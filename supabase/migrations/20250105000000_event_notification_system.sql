-- ====================================================================
-- ConvertCast Event Notification System Migration
-- Version: 1.0.0
-- Date: 2025-01-05
...
-- Trigger for event_notifications
...
-- ============================================
-- STEP 5: Create trigger to auto-create analytics
-- ============================================
...
DROP TRIGGER IF EXISTS create_event_analytics_trigger ON events;
...
-- ============================================
-- STEP 8: Sample data views for analytics
-- ============================================

-- View for event performance dashboard
...
-- ============================================
-- STEP 9: Notification tracking functions
-- ============================================
...
VALUES ('20250105000000_event_notification_system', NOW())
