-- ====================================================================
-- ConvertCast User Integrations System Migration
-- Version: 1.0.0
-- Date: 2025-01-05
...
CREATE TABLE IF NOT EXISTS user_integrations (
  ...
  -- Ensure only one primary per service type per user
  UNIQUE(user_id, service_type, is_primary) WHERE is_primary = true
);
...
CREATE INDEX IF NOT EXISTS idx_user_integrations_is_primary ON user_integrations(user_id, service_type, is_primary) WHERE is_primary = true;
